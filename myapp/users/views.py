...
from myapp.models import User, ThankfulPost
...
def user_posts(username):
    ...
    thankful_posts = ThankfulPost.query.filter_by(author=user).order_by(ThankfulPost.date.desc()).paginate(page=page, per_page=5)
    return render_template('user_posts.html', thankful_posts=thankful_posts, user=user)